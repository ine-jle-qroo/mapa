...
var format_Solidaridad_5 = new ol.format.GeoJSON();
var features_Solidaridad_5 = format_Solidaridad_5.readFeatures(json_Solidaridad_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Solidaridad_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Solidaridad_5.addFeatures(features_Solidaridad_5);
var lyr_Solidaridad_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Solidaridad_5, 
                style: style_Solidaridad_5,
                popuplayertitle: 'Solidaridad',
                interactive: true,
                title: '<img src="styles/legend/Solidaridad_5.png" /> Solidaridad'
            });
var format_Tulum_6 = new ol.format.GeoJSON();
var features_Tulum_6 = format_Tulum_6.readFeatures(json_Tulum_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Tulum_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Tulum_6.addFeatures(features_Tulum_6);
var lyr_Tulum_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Tulum_6, 
                style: style_Tulum_6,
                popuplayertitle: 'Tulum',
                interactive: true,
                title: '<img src="styles/legend/Tulum_6.png" /> Tulum'
            });

lyr_GoogleRoad_0.setVisible(true);lyr_Bacalar_1.setVisible(true);lyr_BenitoJurez_2.setVisible(true);lyr_FelipeCarrilloPuerto_3.setVisible(true);lyr_OthonPBlanco_4.setVisible(true);lyr_Solidaridad_5.setVisible(true);lyr_Tulum_6.setVisible(true);
var layersList = [lyr_GoogleRoad_0,lyr_Bacalar_1,lyr_BenitoJurez_2,lyr_FelipeCarrilloPuerto_3,lyr_OthonPBlanco_4,lyr_Solidaridad_5,lyr_Tulum_6];
...
lyr_Solidaridad_5.set('fieldAliases', {'X': 'X', 'Y': 'Y', 'MAC': 'MAC', 'Municipio': 'Municipio', 'Localidad': 'Localidad', 'Ubicación': 'Ubicación', 'Estancia': 'Estancia', 'fin': 'fin', 'Horario': 'Horario', 'RM': 'RM', 'Enlace': 'Enlace', 'Imagen': 'Imagen', });
lyr_Tulum_6.set('fieldAliases', {'X': 'X', 'Y': 'Y', 'MAC': 'MAC', 'Municipio': 'Municipio', 'Localidad': 'Localidad', 'Ubicación': 'Ubicación', 'Estancia': 'Estancia', 'fin': 'fin', 'Horario': 'Horario', 'RM': 'RM', 'Enlace': 'Enlace', 'Imagen': 'Imagen', });
...
lyr_Solidaridad_5.set('fieldImages', {'X': 'Hidden', 'Y': 'Hidden', 'MAC': 'Hidden', 'Municipio': 'Hidden', 'Localidad': 'TextEdit', 'Ubicación': 'TextEdit', 'Estancia': 'TextEdit', 'fin': 'Hidden', 'Horario': 'TextEdit', 'RM': 'TextEdit', 'Enlace': 'TextEdit', 'Imagen': 'ExternalResource', });
lyr_Tulum_6.set('fieldImages', {'X': 'Hidden', 'Y': 'Hidden', 'MAC': 'Hidden', 'Municipio': 'Hidden', 'Localidad': 'TextEdit', 'Ubicación': 'TextEdit', 'Estancia': 'TextEdit', 'fin': 'Hidden', 'Horario': 'TextEdit', 'RM': 'TextEdit', 'Enlace': 'TextEdit', 'Imagen': 'ExternalResource', });
...
lyr_Solidaridad_5.set('fieldLabels', {'Localidad': 'header label - always visible', 'Ubicación': 'header label - always visible', 'Estancia': 'header label - always visible', 'Horario': 'header label - always visible', 'RM': 'header label - always visible', 'Enlace': 'header label - always visible', 'Imagen': 'no label', });
lyr_Tulum_6.set('fieldLabels', {'Localidad': 'header label - always visible', 'Ubicación': 'header label - always visible', 'Estancia': 'header label - always visible', 'Horario': 'header label - always visible', 'RM': 'header label - always visible', 'Enlace': 'header label - always visible', 'Imagen': 'no label', });
lyr_Tulum_6.on('precompose', function(evt) {
