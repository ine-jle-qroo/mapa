...
lyr_GoogleRoad_0.setVisible(true);lyr_Bacalar_1.setVisible(true);lyr_BenitoJurez_2.setVisible(true);lyr_FelipeCarrilloPuerto_3.setVisible(true);lyr_IslaMujeres_4.setVisible(true);lyr_LzaroCrdenas_5.setVisible(true);lyr_OthnPBlanco_6.setVisible(true);lyr_PuertoMorelos_7.setVisible(true);
var layersList = [lyr_GoogleRoad_0,lyr_Bacalar_1,lyr_BenitoJurez_2,lyr_FelipeCarrilloPuerto_3,lyr_IslaMujeres_4,lyr_LzaroCrdenas_5,lyr_OthnPBlanco_6,lyr_PuertoMorelos_7];
...
lyr_PuertoMorelos_7.set('fieldLabels', {'Localidad': 'header label - visible with data', 'Ubicación': 'header label - visible with data', 'Estancia': 'header label - visible with data', 'Horario': 'header label - visible with data', 'RM': 'header label - visible with data', 'Enlace': 'header label - visible with data', 'Imagen': 'no label', });
