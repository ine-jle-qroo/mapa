...
lyr_GoogleRoad_0.setVisible(true);lyr_Bacalar_1.setVisible(true);lyr_BenitoJurez_2.setVisible(true);lyr_IslaMujeres_3.setVisible(true);lyr_JosMaraMorelos_4.setVisible(true);lyr_LzaroCrdenas_5.setVisible(true);lyr_OthonPBlanco_6.setVisible(true);lyr_PuertoMorelos_7.setVisible(true);lyr_Solidaridad_8.setVisible(true);
var layersList = [lyr_GoogleRoad_0,lyr_Bacalar_1,lyr_BenitoJurez_2,lyr_IslaMujeres_3,lyr_JosMaraMorelos_4,lyr_LzaroCrdenas_5,lyr_OthonPBlanco_6,lyr_PuertoMorelos_7,lyr_Solidaridad_8];
