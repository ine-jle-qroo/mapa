...
var format_Tulum_8 = new ol.format.GeoJSON();
var features_Tulum_8 = format_Tulum_8.readFeatures(json_Tulum_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Tulum_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Tulum_8.addFeatures(features_Tulum_8);
var lyr_Tulum_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Tulum_8, 
                style: style_Tulum_8,
                popuplayertitle: 'Tulum',
                interactive: true,
                title: '<img src="styles/legend/Tulum_8.png" /> Tulum'
            });

lyr_GoogleRoad_0.setVisible(true);lyr_Bacalar_1.setVisible(true);lyr_BenitoJurez_2.setVisible(true);lyr_IslaMujeres_3.setVisible(true);lyr_JosMaraMorelos_4.setVisible(true);lyr_LzaroCrdenas_5.setVisible(true);lyr_OthonPBlanco_6.setVisible(true);lyr_Solidaridad_7.setVisible(true);lyr_Tulum_8.setVisible(true);
var layersList = [lyr_GoogleRoad_0,lyr_Bacalar_1,lyr_BenitoJurez_2,lyr_IslaMujeres_3,lyr_JosMaraMorelos_4,lyr_LzaroCrdenas_5,lyr_OthonPBlanco_6,lyr_Solidaridad_7,lyr_Tulum_8];
...
lyr_Tulum_8.set('fieldAliases', {'X': 'X', 'Y': 'Y', 'MAC': 'MAC', 'Municipio': 'Municipio', 'Localidad': 'Localidad', 'Ubicación': 'Ubicación', 'Estancia': 'Estancia', 'fin': 'fin', 'Horario': 'Horario', 'RM': 'RM', 'Enlace': 'Enlace', 'Imagen': 'Imagen', });
...
lyr_Tulum_8.set('fieldImages', {'X': 'Hidden', 'Y': 'Hidden', 'MAC': 'Hidden', 'Municipio': 'Hidden', 'Localidad': 'TextEdit', 'Ubicación': 'TextEdit', 'Estancia': 'TextEdit', 'fin': 'Hidden', 'Horario': 'TextEdit', 'RM': 'TextEdit', 'Enlace': 'TextEdit', 'Imagen': 'ExternalResource', });
...
lyr_Tulum_8.set('fieldLabels', {'Localidad': 'header label - always visible', 'Ubicación': 'header label - always visible', 'Estancia': 'header label - always visible', 'Horario': 'header label - always visible', 'RM': 'header label - always visible', 'Enlace': 'header label - always visible', 'Imagen': 'no label', });
lyr_Tulum_8.on('precompose', function(evt) {
