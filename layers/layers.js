...
lyr_GoogleRoad_0.setVisible(true);lyr_Bacalar_1.setVisible(true);lyr_BenitoJurez_2.setVisible(true);lyr_JosMaraMorelos_3.setVisible(true);lyr_OthonPBlanco_4.setVisible(true);lyr_PuertoMorelos_5.setVisible(true);lyr_Solidaridad_6.setVisible(true);
var layersList = [lyr_GoogleRoad_0,lyr_Bacalar_1,lyr_BenitoJurez_2,lyr_JosMaraMorelos_3,lyr_OthonPBlanco_4,lyr_PuertoMorelos_5,lyr_Solidaridad_6];
