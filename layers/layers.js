...
lyr_GoogleRoad_0.setVisible(true);lyr_Bacalar_1.setVisible(true);lyr_BenitoJurez_2.setVisible(true);lyr_FelipeCarrilloPuerto_3.setVisible(true);lyr_LzaroCrdenas_4.setVisible(true);lyr_OthonPBlanco_5.setVisible(true);lyr_PuertoMorelos_6.setVisible(true);
var layersList = [lyr_GoogleRoad_0,lyr_Bacalar_1,lyr_BenitoJurez_2,lyr_FelipeCarrilloPuerto_3,lyr_LzaroCrdenas_4,lyr_OthonPBlanco_5,lyr_PuertoMorelos_6];
...
lyr_PuertoMorelos_6.on('precompose', function(evt) {
