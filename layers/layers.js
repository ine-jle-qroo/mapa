...
var format_IslaMujeres_3 = new ol.format.GeoJSON();
var features_IslaMujeres_3 = format_IslaMujeres_3.readFeatures(json_IslaMujeres_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_IslaMujeres_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_IslaMujeres_3.addFeatures(features_IslaMujeres_3);
var lyr_IslaMujeres_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_IslaMujeres_3, 
                style: style_IslaMujeres_3,
                popuplayertitle: 'Isla Mujeres',
                interactive: true,
                title: '<img src="styles/legend/IslaMujeres_3.png" /> Isla Mujeres'
            });
...
var format_OthnPBlanco_6 = new ol.format.GeoJSON();
var features_OthnPBlanco_6 = format_OthnPBlanco_6.readFeatures(json_OthnPBlanco_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_OthnPBlanco_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_OthnPBlanco_6.addFeatures(features_OthnPBlanco_6);
var lyr_OthnPBlanco_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_OthnPBlanco_6, 
                style: style_OthnPBlanco_6,
                popuplayertitle: 'Othón P Blanco',
                interactive: true,
                title: '<img src="styles/legend/OthnPBlanco_6.png" /> Othón P Blanco'
            });
var format_PuertoMorelos_7 = new ol.format.GeoJSON();
var features_PuertoMorelos_7 = format_PuertoMorelos_7.readFeatures(json_PuertoMorelos_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PuertoMorelos_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PuertoMorelos_7.addFeatures(features_PuertoMorelos_7);
var lyr_PuertoMorelos_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PuertoMorelos_7, 
                style: style_PuertoMorelos_7,
                popuplayertitle: 'Puerto Morelos',
                interactive: true,
                title: '<img src="styles/legend/PuertoMorelos_7.png" /> Puerto Morelos'
            });

lyr_GoogleRoad_0.setVisible(true);lyr_Bacalar_1.setVisible(true);lyr_BenitoJurez_2.setVisible(true);lyr_IslaMujeres_3.setVisible(true);lyr_JosMaraMorelos_4.setVisible(true);lyr_LzaroCrdenas_5.setVisible(true);lyr_OthnPBlanco_6.setVisible(true);lyr_PuertoMorelos_7.setVisible(true);
var layersList = [lyr_GoogleRoad_0,lyr_Bacalar_1,lyr_BenitoJurez_2,lyr_IslaMujeres_3,lyr_JosMaraMorelos_4,lyr_LzaroCrdenas_5,lyr_OthnPBlanco_6,lyr_PuertoMorelos_7];
...
lyr_IslaMujeres_3.set('fieldAliases', {'X': 'X', 'Y': 'Y', 'MAC': 'MAC', 'Municipio': 'Municipio', 'Localidad': 'Localidad', 'Ubicación': 'Ubicación', 'Estancia': 'Estancia', 'fin': 'fin', 'Horario': 'Horario', 'RM': 'RM', 'Enlace': 'Enlace', 'Imagen': 'Imagen', });
...
lyr_OthnPBlanco_6.set('fieldAliases', {'X': 'X', 'Y': 'Y', 'MAC': 'MAC', 'Municipio': 'Municipio', 'Localidad': 'Localidad', 'Ubicación': 'Ubicación', 'Estancia': 'Estancia', 'fin': 'fin', 'Horario': 'Horario', 'RM': 'RM', 'Enlace': 'Enlace', 'Imagen': 'Imagen', });
lyr_PuertoMorelos_7.set('fieldAliases', {'X': 'X', 'Y': 'Y', 'MAC': 'MAC', 'Municipio': 'Municipio', 'Localidad': 'Localidad', 'Ubicación': 'Ubicación', 'Estancia': 'Estancia', 'fin': 'fin', 'Horario': 'Horario', 'RM': 'RM', 'Enlace': 'Enlace', 'Imagen': 'Imagen', });
...
lyr_IslaMujeres_3.set('fieldImages', {'X': 'Hidden', 'Y': 'Hidden', 'MAC': 'Hidden', 'Municipio': 'Hidden', 'Localidad': 'TextEdit', 'Ubicación': 'TextEdit', 'Estancia': 'TextEdit', 'fin': 'Hidden', 'Horario': 'TextEdit', 'RM': 'TextEdit', 'Enlace': 'TextEdit', 'Imagen': 'ExternalResource', });
...
lyr_OthnPBlanco_6.set('fieldImages', {'X': 'Hidden', 'Y': 'Hidden', 'MAC': 'Hidden', 'Municipio': 'Hidden', 'Localidad': 'TextEdit', 'Ubicación': 'TextEdit', 'Estancia': 'TextEdit', 'fin': 'Hidden', 'Horario': 'TextEdit', 'RM': 'TextEdit', 'Enlace': 'TextEdit', 'Imagen': 'ExternalResource', });
lyr_PuertoMorelos_7.set('fieldImages', {'X': 'Hidden', 'Y': 'Hidden', 'MAC': 'Hidden', 'Municipio': 'Hidden', 'Localidad': 'TextEdit', 'Ubicación': 'TextEdit', 'Estancia': 'TextEdit', 'fin': 'Hidden', 'Horario': 'TextEdit', 'RM': 'TextEdit', 'Enlace': 'TextEdit', 'Imagen': 'ExternalResource', });
...
lyr_IslaMujeres_3.set('fieldLabels', {'Localidad': 'header label - always visible', 'Ubicación': 'header label - always visible', 'Estancia': 'header label - always visible', 'Horario': 'header label - always visible', 'RM': 'header label - always visible', 'Enlace': 'header label - always visible', 'Imagen': 'no label', });
...
lyr_OthnPBlanco_6.set('fieldLabels', {'Localidad': 'header label - always visible', 'Ubicación': 'header label - always visible', 'Estancia': 'header label - always visible', 'Horario': 'header label - always visible', 'RM': 'header label - always visible', 'Enlace': 'header label - always visible', 'Imagen': 'no label', });
lyr_PuertoMorelos_7.set('fieldLabels', {'Localidad': 'header label - always visible', 'Ubicación': 'header label - always visible', 'Estancia': 'header label - always visible', 'Horario': 'header label - always visible', 'RM': 'header label - always visible', 'Enlace': 'header label - always visible', 'Imagen': 'no label', });
lyr_PuertoMorelos_7.on('precompose', function(evt) {
